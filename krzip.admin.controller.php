...
class krzipAdminController extends krzip
{
    ...
    {
        $args = Context::gets('krzip_server_url', 'krzip_map_provider', 'krzip_server_request_format', 'krzip_postcode_format', 'krzip_require_exact_query', 'krzip_use_full_jibeon');
